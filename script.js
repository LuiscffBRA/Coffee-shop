...
document.addEventListener("DOMContentLoaded", () => {
    // Adicionando o estilo para a cor de fundo do carrinho
  const style = document.createElement("style");
  style.innerHTML = `
    .cart-container {
      background-color: #b8946c; /* Cor amarela suave */
      padding: 20px;
      border-radius: 8px;
    }
  `;
  ...
  navbar.innerHTML = `
    <div class="nav-title">Verve Coffee</div>
    <div class="nav-links">
      <a href="#section1" id="link-products">Coffees</a>
      <a href="#section2" id="link-cart">Cart</a>
    </div>
  `;
